...
public class FellowPlusComInvest {
	static String prefix = "http://dataapi.fellowplus.com/project/invest?_id=12463&_token=uBUUafkzqIDKT10IErz5gTQb%2F%2FngqVigptOimBB157s%3D&id=";
	...
	public static void runner() {
		try {
			FileWriter fw = new FileWriter("data/dp/com_invest.txt",true);
			...
			for (String id : crawlSet) {
				...
				fw.write(id + "\t" + resultObj.getString("invests") + "\r\n");
				fw.flush();
				Thread.sleep(500);
			}
			reader.close();
	...
	public static Set<String> getCrawlSet() throws Exception {
		...
		br = BufferedReaderUtil.getBuffer("data/dp/com_invest.txt");
		while ((input = br.readLine())!=null) {
